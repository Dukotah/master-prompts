...
- **State:** Owner's comprehensive P1 sweep landed on main (a86dff79, June 8 05:31): P1.2 custom SVG
  ...
  **overseer/2026-06-08-p2b** (a48ea9b, Run J): 10th accessibility check — "ARIA roles are valid"
  ...
  methodology.html: "ten checks" + new table row. Branched from p2a. **1 ahead of p2a.**
  **overseer/2026-06-08-p2c** (43b69f2, Run K): 11th accessibility check — "Tab order preserved"
  ...
  methodology.html: "eleven checks" + new table row. **1 ahead of p2b.**
  **overseer/2026-06-08-p2d** (a563c41, Run L): 12th accessibility check — "Video captions"
  ...
  WCAG_URL map extended with 1.2.2 → captions-prerecorded. **1 ahead of p2c / 4 ahead of main.**
